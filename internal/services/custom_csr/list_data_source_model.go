...
type CustomCsrsResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[CustomCsrsResultDataSourceModel] `json:"result,computed"`
}
...
type CustomCsrsResultDataSourceModel struct {
