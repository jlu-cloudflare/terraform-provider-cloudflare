...
var _ datasource.DataSourceWithConfigValidators = (*FlagshipFlagDataSource)(nil)
	...
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"rules": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[FlagshipFlagRulesDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"conditions": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									...
									"clauses": schema.ListNestedAttribute{
										Computed:   true,
										CustomType: customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsClausesDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"attribute": schema.StringAttribute{
													Computed: true,
												...
												"clauses": schema.ListNestedAttribute{
													Computed:   true,
													CustomType: customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsClausesClausesDataSourceModel](ctx),
													NestedObject: schema.NestedAttributeObject{
														Attributes: map[string]schema.Attribute{
															"attribute": schema.StringAttribute{
																Computed: true,
															...
															"clauses": schema.ListNestedAttribute{
																Computed:   true,
																CustomType: customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsClausesClausesClausesDataSourceModel](ctx),
																NestedObject: schema.NestedAttributeObject{
																	Attributes: map[string]schema.Attribute{
																		"attribute": schema.StringAttribute{
																			Computed: true,
																		...
																		"clauses": schema.ListNestedAttribute{
																			Computed:   true,
																			CustomType: customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsClausesClausesClausesClausesDataSourceModel](ctx),
																			NestedObject: schema.NestedAttributeObject{
																				Attributes: map[string]schema.Attribute{
																					"attribute": schema.StringAttribute{
																						Computed: true,
																					...
																					"clauses": schema.ListNestedAttribute{
																						Computed:   true,
																						CustomType: customfield.NewNestedObjectListType[FlagshipFlagRulesConditionsClausesClausesClausesClausesClausesDataSourceModel](ctx),
																						NestedObject: schema.NestedAttributeObject{
																							Attributes: map[string]schema.Attribute{
																								"attribute": schema.StringAttribute{
																									Computed: true,
...
func (d *FlagshipFlagDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
